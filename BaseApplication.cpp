...
void BaseApplication::createFrameListener(void)
{
    ...
    mDetailsPanel = mTrayMgr->createParamsPanel(
		OgreBites::TL_NONE, "DetailsPanel", 200, getDetailsPanelFields());
    mDetailsPanel->hide();
...
Ogre::StringVector BaseApplication::getDetailsPanelFields()
{
...
void BaseApplication::updateDetailsPanelContent()
{
	...
	mDetailsPanel->setParamValue(9, filtering);
	...
	mDetailsPanel->setParamValue(10, polyMode);
}
